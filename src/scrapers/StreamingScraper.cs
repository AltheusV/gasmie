...
namespace gasmie.src
{
    public class StreamingScraper : Scraper
    {
        ...
        private string DigImage()
        {
            ...
            return imageNode == null ? "" : $"{imageNode[0].OuterHtml.Split(" ")[3].Replace("\"", "").Replace("data-src=", "")}.jpg";
        }

        private string DigName()
        {
            var nameNode = Document.DocumentNode.SelectNodes("//div[@class='title-block']/div/h1");
            return nameNode == null ? "" : nameNode[0].InnerText.Trim();
        }
        ...
        private string DigEpisodes()
        {
            ...
            return episodesNode == null ? "" : episodesNode.Where(e => e.InnerHtml.Contains("Episodes")).First().InnerHtml.Trim();
        }
        ...
        private string DigGenres()
        {
            ...
            return genresNode == null ? "" : genresNode[1].InnerText.Trim().Replace(" ,", ",").Replace("&amp;", "&");
        }
        ...
        private string DigDuration()
        {
            ...
            return durationNode == null ? "" : durationNode[2].InnerText.Trim();
        }
    }
}